...
<article class="col-md-12">
    ...
    <div>
        ...
        <form class="formcomment text-center" action="index.php?page=addComment&amp;id=<?= $post['id'] ?>" method="post">
            <div class="form-row">
                <div class="col">
            ...
            <button class="btn btn-outline-secondary" type="submit"><i class="fas fa-envelope"></i> &nbsp; Envoyer le commentaire</button>
        </form>
    </div>
    <?php
    ...
    ?>
    <div>
        <div><span class="datepost float-right">Posté le
            <?= $comment['comment_date_fr'] ?></span>
